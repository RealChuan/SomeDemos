...
void HttpClientAsync::get(const std::string &url, const Headers &headers, Callback callback)
{
    sendCustomRequest(url, "GET", "", headers, callback);
}

void HttpClientAsync::post(const std::string &url,
...
void HttpClientAsync::put(const std::string &url,
                          const std::string &data,
                          const Headers &headers,
                          Callback callback)
{
...
void HttpClientAsync::del(const std::string &url, const Headers &headers, Callback callback)
{
    sendCustomRequest(url, "DELETE", "", headers, callback);
}

void HttpClientAsync::options(const std::string &url, const Headers &headers, Callback callback)
{
    sendCustomRequest(url, "OPTIONS", "", headers, callback);
}

void HttpClientAsync::patch(const std::string &url,
                            const std::string &data,
                            const Headers &headers,
                            Callback callback)
{
...
void HttpClientAsync::download(const std::string &url,
...
void HttpClientAsync::upload_put(const std::string &url,
                                 const std::filesystem::path &path,
                                 const Headers &headers,
                                 Callback callback)
{
...
void HttpClientAsync::upload_post(const std::string &url,
                                  const std::filesystem::path &path,
                                  const Headers &headers,
                                  Callback callback)
{
